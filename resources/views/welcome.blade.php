...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="grid lg:grid-cols-2 gap-12 bg-[url('/public/img/bglaundry6.jpeg')] bg-cover bg-center sm:px-8 px-4 py-20 h-screen">
    <!-- Left Section -->
    <div>
      <a href="#">
      <div class="flex items-center space-x-1">
        <img src="{{ asset('img/Cemara.png') }}" alt="Logo CemaraLaundry" class="h-10 w-10">
        <h1 class="text-white font-sans text-2xl font-bold">CemaraLaundry</h1>
      </div></a>
      <div class="max-w-lg mt-16 max-lg:hidden">
        <h3 class="text-3xl font-bold text-white">"Keep It Clean, Keep It Simple"</h3>
        <p class="text-sm mt-4 text-white">Sign in to keep your laundry journey simple and fresh. Experience the ease of clean and cared-for laundry.</p>
      </div>
    </div>
    ...
    @csrf
    <!-- Right Section -->
    <div class="rounded-xl sm:px-6 px-4 py-8 max-w-md w-full shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] mx-auto bg-[url('/public/img/bglaundry5.jpg')] bg-cover bg-center">
      <form>
        <div class="mb-8">
        ...
        <div class="mt-8">
          ...
          <button type="button" class="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
            Log in
          </button>
        </div>
        ...
        <p class="text-sm mt-6 text-center text-gray-800">
          ...
          <a href="javascript:void(0);" class="text-blue-600 font-semibold hover:underline ml-1">Register here</a>
        </p>
      </form>
    </div>
  </div>
